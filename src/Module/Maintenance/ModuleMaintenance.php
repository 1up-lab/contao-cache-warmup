...
class ModuleMaintenance extends Backend implements \executable
{
    ...
    public function __construct()
    {
        ...
        if ('BE' === TL_MODE) {
            $GLOBALS['TL_CSS'][] = 'bundles/oneupcontaopagecachewarmup/css/module.css';

            if ($this->isActive()) {
                $GLOBALS['TL_JAVASCRIPT'][] = 'assets/jquery/js/jquery.min.js|static';
                $GLOBALS['TL_JAVASCRIPT'][] = 'bundles/oneupcontaopagecachewarmup/js/jquery.ajaxQueue.js|static';
            }
        }
    }
    ...
    public function run()
    {
        ...
        if ('page_cache_warmup' === Input::get('act')) {
